...
$querypenyakit = mysqli_query($conn, "SELECT COUNT(*) AS total_penyakit FROM tb_solusi");
$resultpenyakit = mysqli_fetch_assoc($querypenyakit);
$totalPenyakit = $resultpenyakit['total_penyakit'];

$queryanalisa = mysqli_query($conn, "SELECT COUNT(*) AS total_analisa FROM tb_pertanyaan");
$resultanalisa = mysqli_fetch_assoc($queryanalisa);
$totalanalisa = $resultanalisa['total_analisa'];

$querykonsultan = mysqli_query($conn, "SELECT COUNT(*) AS total_konsultan FROM tb_konsultan");
$resultkonsultan = mysqli_fetch_assoc($querykonsultan);
$totalkonsultan = $resultkonsultan['total_konsultan'];

$queryadmin = mysqli_query($conn, "SELECT COUNT(*) AS total_admin FROM tb_admin");
$resultadmin = mysqli_fetch_assoc($queryadmin);
$totaladmin = $resultadmin['total_admin'];
  ...
  <aside
    ...
    <div class="h-19.5">
      <i class="absolute top-0 right-0 hidden p-4 opacity-50 cursor-pointer fas fa-times text-slate-400 xl:hidden"
        sidenav-close></i>
      <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="../pages/dashboard.php"
        target="_blank">
        <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Dogy Healthy</span>
      </a>
    </div>
      ...
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Data Penyakit</span>
          </a>
        </li>

        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
            href="../build/pages/billing.php">
            <div
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Data Pemeriksaan</span>
          </a>
        </li>
            ...
            <div class="flex-auto p-4">
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                    <p class="mb-0 font-sans text-sm font-semibold leading-normal">Data Penyakit</p>
                    <h5 class="mb-0 font-bold">
                      <?php echo $totalPenyakit; ?>
                      <span class="text-xs leading-normal font-weight-bolder text-lime-500">Jenis Penyakit</span>
                    </h5>
                  </div>
                </div>
          ...
          <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
            <div class="flex-auto p-4">
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                    <p class="mb-0 font-sans text-sm font-semibold leading-normal">Jumlah Analisa</p>
                    <h5 class="mb-0 font-bold">
                      <?php echo $totalanalisa; ?>
                      <span class="text-xs leading-normal font-weight-bolder text-lime-500">Analisa</span>
                    </h5>
                  </div>
                </div>
                <div class="px-3 text-right basis-1/3">
          ...
          <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
            <div class="flex-auto p-4">
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                    <p class="mb-0 font-sans text-sm font-semibold leading-normal">Data Pemeriksaan</p>
                    <h5 class="mb-0 font-bold">
                      <?php echo $totalkonsultan; ?>
                      <span class="text-xs leading-normal text-red-600 font-weight-bolder">Konsultan</span>
                    </h5>
                  </div>
                </div>
                <div class="px-3 text-right basis-1/3">
          ...
          <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
            <div class="flex-auto p-4">
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                    <p class="mb-0 font-sans text-sm font-semibold leading-normal">Pengelola</p>
                    <h5 class="mb-0 font-bold">
                      <?php echo $totaladmin; ?>
                      <span class="text-xs leading-normal font-weight-bolder text-lime-500">Admin</span>
                    </h5>
                  </div>
                </div>
                <div class="px-3 text-right basis-1/3">
    ...
    <div fixed-plugin-card
      ...
      <div class="px-6 pt-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl">
        <div class="float-left">
          <h5 class="mt-4 mb-0">Configurator</h5>
