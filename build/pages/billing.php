        ...
        <nav>
          ...
          <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li
              ...
              aria-current="page">Data Pemeriksaan</li>
          </ol>
          <h6 class="mb-0 font-bold capitalize">Data Pemeriksaan</h6>
        </nav>
        ...
        <div
          ...
          <div class="flex-auto p-4 pt-6">
            <ul class="flex flex-col pl-0 mb-0 rounded-lg">
              <?php
              // Query untuk mengambil data dari tabel tb_konsultan
              $queryKonsultan = mysqli_query($conn, "SELECT * FROM tb_konsultan");

              // Loop melalui hasil query
              while ($row = mysqli_fetch_assoc($queryKonsultan)) {
                ?>
                <li class="relative flex p-6 mb-2 border-0 rounded-t-inherit rounded-xl bg-gray-50">
                  <div class="flex flex-col">
                    <h6 class="mb-4 leading-normal text-sm">
                      <?php echo $row['nama_konsultan']; ?>
                    </h6>
                    <span class="mb-2 leading-tight text-xs">Jenis Anjing <span
                        class="font-semibold text-slate-700 sm:ml-2">
                        <?php echo $row['jenis_anjing']; ?>
                      </span></span>
                    <span class="mb-2 leading-tight text-xs">Umur Peliharaan: <span
                        class="font-semibold text-slate-700 sm:ml-2">
                        <?php echo $row['umur_anjing']; ?>
                      </span></span>
                    <span class="leading-tight text-xs">Hasil Analisis: <span
                        class="font-semibold text-slate-700 sm:ml-2">
                        <?php echo $row['hasil']; ?>
                      </span></span>
                  </div>
                  <div class="ml-auto text-right">
                    <a id="delete"
                      ...
                      onclick="confirmDelete(<?= $contact['id'] ?>"><i
  ...
  function confirmDelete(contactId) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = 'hapus_k.php?id=' + contactId;
      }
    });
  }
</script>
