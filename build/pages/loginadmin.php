              ...
              <div
                ...
                <div class="p-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                  <h3
                    ...
                    Selamat datang admin</h3>
                  <p class="mb-0">Login untuk masuk ke halaman admin</p>
                  <a type="button" onclick="loguser();"
                    class="bg-gradient-to-tl from-green-600 to-lime-400 no-underline cursor-pointer text-center align-middle py-2 mr-2 my-2 px-2 rounded-xl text-xs font-medium text-white">Login
                    User</a>
                </div>
...
<script>
  ...
  function loguser() {
    Swal.fire({
      ...
      text: 'Kamu akan masuk website sebagai user!',
    }).then((result) => {
