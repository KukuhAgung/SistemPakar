        ...
        <div class="flex flex-wrap -mx-3">
          <div class="flex-none w-auto max-w-full px-3">
            <div
              ...
              <img src="../assets/img/happy.png" alt="profile_image" class="w-full shadow-soft-sm rounded-xl" />
            </div>
          </div>
          <div class="flex-none w-auto max-w-full px-3 my-auto">
            <div class="h-full">
              <h5 class="mb-1">Admin</h5>
              <p class="mb-0 font-semibold leading-normal text-sm">Pakar</p>
            </div>
          </div>
        ...
        <div class="w-full max-w-full px-3 lg-max:mt-6 xl:w-4/12">
          <div
            ...
            <div class="flex-auto p-4">
              <p class="leading-normal text-sm">Halo, Saya adalah pakar dari website Dogy Healthy. Saya harap website
                ini dapat membantu untuk mendiagnosa peliharaanmu.</p>
              ...
              <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                <li
                  ...
                  <strong class="text-slate-700">Nama Lengkap:</strong> &nbsp; Rahasia
                </li>
                <li
                  class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                  <strong class="text-slate-700">No HP:</strong> &nbsp; (+62) 8953 2110 4929
                </li>
                <li
                  class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                  <strong class="text-slate-700">Email:</strong> &nbsp; anculapuak07@gmail.com
                </li>
                <li
                  class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                  <strong class="text-slate-700">Lokasi:</strong> &nbsp; -
                </li>
              </ul>
            </div>
          </div>
