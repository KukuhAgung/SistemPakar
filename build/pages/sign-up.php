  ...
  <nav
    ...
    <div class="container flex items-center justify-between py-0 flex-wrap-inherit">
      <a class="py-2.375 text-sm mr-4 ml-4 whitespace-nowrap font-bold text-white lg:ml-0"
        href="../pages/dashboard.php"> Sistem Pakar Penyakit Anjing</a>
  ...
  <main class="mt-0 transition-all duration-200 ease-soft-in-out">
    <section class="min-h-screen mb-32">
      <div
        ...
        style="background-image: url('../assets/img/curved-images/dentis.jpg')">
        <span
        ...
        <div class="container z-10">
          <div class="flex flex-wrap justify-center -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12">
              ...
              <p class="text-white">Ayo bergabung untuk mulai mendiagnosa penyakit peliharaanmu.</p>
            </div>
          </div>
        </div>
      </div>
                ...
                <form action="" method="post" onsubmit="return validateForm()">
                  ...
                  <div class="min-h-6 pl-6.92 mb-0.5 block">
                    ...
                    <label class="mb-2 ml-1 font-normal cursor-pointer select-none text-sm text-slate-700" for="terms">
                      Saya setuju dengan <a href="javascript:;" class="font-bold text-slate-700">Kebijakan Privasi</a>
                    </label>
                  </div>
                  ...
                  <p class="mt-4 mb-0 leading-normal text-sm">Sudah punya akun? <a href="../pages/sign-in.php"
                      class="font-bold text-slate-700">Login</a></p>
                </form>
              </div>
            </div>
          </div>
