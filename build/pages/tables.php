...
$stmt = $conn->prepare('SELECT * FROM tb_solusi ORDER BY id LIMIT :current_page, :record_per_page');
...
$num_contacts = $conn->query('SELECT COUNT(*) FROM tb_solusi')->fetchColumn();
?>
        ...
        <nav>
          ...
          <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li
              ...
              aria-current="page">Data Penyakit</li>
          </ol>
          <h6 class="mb-0 font-bold capitalize">Data Penyakit</h6>
        </nav>
        ...
        <div class="flex-none w-full max-w-full px-3">
          <div
            ...
            <div class="flex justify-between">
              ...
              <a href="create_penyakit.php" type="button"
                class="bg-gradient-to-tl from-green-600 to-lime-400 no-underline cursor-pointer text-center align-middle py-2 mr-2 my-2 px-2 rounded-xl text-xs font-medium text-white">Tambah
                Data</a>
            </div>
            <div class="flex-auto px-0 pt-0 pb-2">
              <div class="p-0 overflow-x-auto">
                  ...
                  <thead class="align-bottom">
                    <tr>
                      ...
                      <th
                        ...
                        Kode Penyakit</th>
                      <th
                        class="px-6 py-3 font-bold text-center justify-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                        Nama Penyakit</th>
                      <th
                        class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                        Penanganan</th>
                    ...
                    <?php foreach ($contacts as $index => $contact): ?>
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <div
                            class="flex flex-col justify-center align-center text-center mb-0 text-xs font-semibold leading-tight">
                            <?= $index + 1 ?>
                          </div>
                </div>
                </td>
                <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                  <div
                    class="flex flex-col justify-center align-center text-center mb-0 text-xs font-semibold leading-tight">
                    <?= $contact['kode_penyakit'] ?>
                  </div>
              </div>
              </td>
              <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                <p class=" text-center mb-0 text-xs font-semibold leading-tight">
                  <?= $contact['nama_penyakit'] ?>
                </p>
              </td>
              <td
              ...
              <td class="action p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                <div class="ml-auto text-center">
                  <a id="delete" onclick="confirmDelete(<?= $contact['id'] ?>)"
                  ...
                  <a id="edit"
                    ...
                    href="Update_penyakit.php?id=<?= $contact['id'] ?>"><i class="mr-2 fas fa-pencil-alt text-slate-700"
...
<script>
  function confirmDelete(contactId) {
    ...
    Swal.fire({
      text: 'Kamu akan beralih ke halaman delete',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        window.location.href = 'hapus_p.php?id=' + contactId;
      }
    });
  }
</script>
