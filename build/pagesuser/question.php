        ...
        <div class="card text-white bg-info mb-3">
            ...
            <div class="card-body text-center ukuran-30">
                ...
                <form method="post" action="input-ketampung.php" enctype="multipart/form-data" role="form">
                    ...
                    $sqlNext = "SELECT kode_pertanyaan FROM tb_pertanyaan WHERE kode_pertanyaan > '$kode' ORDER BY kode_pertanyaan ASC LIMIT 1";
                    $dataNext = mysqli_query($connect, $sqlNext);
                    ?>
